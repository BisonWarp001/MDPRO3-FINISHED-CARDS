...
function s.tktg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if chk==0 then
        return c:IsFaceup() and ft>0
            and Duel.IsPlayerCanSpecialSummonMonster(tp,200000021,0,TYPES_TOKEN,500,500,1,RACE_AQUA,ATTRIBUTE_WATER)
    end
...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
    ...
    for i=1,ct do
        if Duel.IsPlayerCanSpecialSummonMonster(tp,200000021,0,TYPES_TOKEN,500,500,1,RACE_AQUA,ATTRIBUTE_WATER) then
            local token=Duel.CreateToken(tp,200000021)
